...
class GameState:
    ...
    def __init__(self, time = 0, round_win_state:WinState = WinState.NO_WIN, set_win_state:WinState = WinState.NO_WIN, p1: PlayerState = PlayerState(), p2: PlayerState = PlayerState()):
        self.time = time
